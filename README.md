...
* **[Automated 3CX Call Center Dashboard](https://github.com/NamthipQingxain/automated-call-center-and-job-sync)**
  * End-to-end data pipeline utilizing Microsoft Power Automate, SharePoint, and Power BI to automate daily report processing and monitor call center KPIs.
* **[Automated OCR SLA Pipeline](https://github.com/NamthipQingxain/automated-ocr-sla-dashboard)**
  * Intelligent data extraction framework using Google Apps Script (OCR) to parse unstructured PDF reports into structured Google Sheets for dynamic SLA tracking.
